<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="GYM_PROJECT_WDDN.WebForm1" %>
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-10">
                            <div class="hero__caption">
                                <span data-animation="fadeInLeft" data-delay="0.1s">Hi We are</span>
                                <h1 data-animation="fadeInLeft" data-delay="0.4s">Muscle Gym</h1>
                                <a href="courses.aspx" class="border-btn hero-btn" data-animation="fadeInLeft" data-delay="0.8s">Our Courses</a>
                            </div>
                        </div>
                    </div>
                </div>          
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">₹1500  <span>(Single class)</span></p>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">₹6400  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                ...
                                <p class="mb-25">₹12000  <span>(Single class)</span></p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="assets/img/icon/check.svg" alt="">
                                    </div>
